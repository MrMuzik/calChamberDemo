...
const summary = {
  summary: `
    Stay on top of San Francisco's labor law posting requirements with this 3-poster set,&nbsp;<strong>designed for businesses with 20 to 99 employees</strong>.&nbsp;Featuring mandatory workplace notices in multiple languages.
  `
};
...
const productTabs = {
  ...
  specifications: `
    <div class="w-full grid grid-cols-2 text-sm">
      ...
      <div class="p-3 bg-white">20 to 99</div>
    </div>
  `,
  ...
  return (
    <>
      ...
      <main class="container mx-auto mt-8 px-4">
        <Promo />
        <Product
          title="San Francisco Labor Law 3-Poster Set"
          imageUrl="/san-francisco-labor-law-posters-3-poster-set.webp"
          breadcrumb="San Francisco Labor Law 3-Poster Set"
          price="$43.49"
          sku="PSFLK"
          summary={summary}
          tabs={productTabs}
