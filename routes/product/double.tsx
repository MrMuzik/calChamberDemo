...
const summary = {
  summary: `
    Stay on top of San Francisco's labor law posting requirements with this 2-poster set,&nbsp;<strong>designed for businesses with 5 to 19 employees</strong>.&nbsp;Featuring mandatory workplace notices in multiple languages.
  `
};
...
const productTabs = {
  ...
  specifications: `
    <div class="w-full grid grid-cols-2 text-sm">
      ...
      <div class="p-3 bg-white">5 to 19</div>
    </div>
  `,
  ...
  return (
    <>
      ...
      <main class="container mx-auto mt-8 px-4">
        <Promo />
        <Product
          title="San Francisco Labor Law 2-Poster Set"
          imageUrl="/san-francisco-labor-law-posters-2-poster-set.webp"
          breadcrumb="San Francisco Labor Law 2-Poster Set"
          price="$29.49"
          sku="PSFLK2"
          summary={summary}
          tabs={productTabs}
